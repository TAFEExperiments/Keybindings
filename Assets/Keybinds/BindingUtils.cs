...
namespace Keybinds
{
    ...
    {
        public static void UpdatePositiveAxisText(string _axis, KeyCode _new, TextMeshProUGUI _text)
        {
            string oldName = TranslateKeycode(BindingManager.GetBindingAxis(_axis).Positive);
            _text.text = BindingManager.GetBindingAxis(_axis).ValueDisplay.Replace(oldName, TranslateKeycode(_new));
        }

        public static void UpdateTextWithBindingAxis(string _binding, TextMeshProUGUI _text)
        {
            _text.text = BindingManager.GetBindingAxis(_binding).ValueDisplay;
        }
